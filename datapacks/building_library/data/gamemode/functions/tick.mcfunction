...
execute as @a[scores={gm=-1..}] run scoreboard players operation @s gamemode = @s gm
...
scoreboard players set @a[scores={gm=-1..}] gm -2
scoreboard players set @a[scores={gamemode=-1..}] gamemode -2
